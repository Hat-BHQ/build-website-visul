...
@app.get("/api/v1/hqa/keyword-seller/keywords")
async def hqa_keyword_seller_keywords(request: Request):
...
@app.get("/api/v1/hqa/keyword-seller/export")
async def hqa_keyword_seller_export(request: Request):
    return await relay("GET", f"{settings.hqa_service_url}/internal/v1/hqa/keyword-seller/export", request)
